...
<head>
    <title>Bright Beginnings Early Learning Center - About Us</title>
    ...
    <section class="classes-section style-two sec-pad">
        ...
        <div class="container">
            <div class="sec-title centred">
                <h5>Our Classess</h5>
                <h1>The Best Quality of Education For Your<br />Children</h1>
            </div>
            <div class="row">
        ...
        <div class="outer-container clearfix">
            <div class="testimonial-column">
                <div class="testimonial-content">
                    <div class="sec-title style-two">
                        <h5>Testimonials</h5>
                        <h1>What Happy Parents Say<br>About Us</h1>
                    </div>
                    <div class="inner-content">
                        <div class="client-testimonial-carousel owl-carousel owl-theme">
                            <div class="testimonial-block">
                                <div class="inner-box">
                                    <div class="author">MRS. SAFINAT AHMED TIJJANI  <span>/ Parent</span></div>
                                    <ul class="rating">
                                    ...
                                    <div class="text">Bright beginnings, words fail me to describe how amazing it is.
...
<div class="abiodun-card">
  <img src="images/main-slider/slider-1.jpg" alt="John" style="width:100%">
  <h3>MRS EILEEN FAFOWORA aka Gee Mama</h3>
  <div class="text">CEO & Propietress, Bright Beginnings Early Learning Center</div>
  <p>I am the prestigious founder of this establishment. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
  ...
  proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
    ...
    <section class="our-teachers style-three about-page sec-pad centred">
        <div class="container">
            <div class="sec-title">
                <h5>Our Staff</h5>
                <h1>It is our <strong>JOB</strong> to ensure your child is given<br />The Best Care</h1>
            </div>
            <div class="inner-content">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                        <div class="teachers-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="#">Ms. ATIM<br> ODIOKINE</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                        <div class="teachers-block-two wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="#">Mrs. IFEOMA CHUKUEMEKA</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                        <div class="teachers-block-two wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="#">Ms. OLUWASEYIFUNMI AJAYI</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                        <div class="teachers-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="#"><img src="images/resource/teacher-1.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <h3><a href="#">Mrs. MARTINAH UNAH</a></h3>
                                    <span class="designation">Nursery Nanny</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                        <div class="teachers-block-two wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="#"><img src="images/resource/teacher-2.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <h3><a href="#">Ms. FAITH<br> OMORUYI</a></h3>
                                    <span class="designation">Teacher</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                        <div class="teachers-block-two wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><a href="#"><img src="images/resource/teacher-3.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <h3><a href="#">Ms. OLAYINKA OTITODUN </a></h3>
                                    <span class="designation">Nursery Nanny</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content-box">
                        <div class="title-box">
                            ...
                            <div class="text">We have a whole raft of activities here at Bright Beginnings Early Learning Center that would certain to educate your kids and entertain them as well!</div>
                        </div>
                        <div class="inner-box">
                            <div class="row">
