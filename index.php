...
include "include/head.php" ?>
    ...
    <section class="main-slider style-three">
        <div class="main-slider-carousel owl-carousel owl-theme nav-style-two">
            <div class="slide" style="background-image:url(images/main-slider/slider-1.png)">
                <div class="container">
            ...
            <div class="slide" style="background-image:url(images/main-slider/slider-2.png)">
                <div class="container">
                    <div class="content-box">
                        <h3>Best Choise</h3>
                        <h1>Make Your Children's Life Special</h1>
            ...
            <div class="slide" style="background-image:url(images/main-slider/slider-3.png)">
                <div class="container">
                    <div class="content-box">
                        <h3>Best Choise</h3>
                        <h1>Make Your Children's Life Special</h1>
    ...
    <!-- about-style-two -->
    <section class="about-style-two centred sec-pad">
        <div class="anim-icon">
        ...
        <div class="container">
            <div class="inner-box">
                <div class="title-box">
                    <div class="sec-title">
                        <h5>About Us</h5>
                        <h1>Welcome to Kidko<br />Kindergarten</h1>
                    </div>
                    <div class="text">Cupidatat non proident sunt culpa qui officia deserunt mollit<br />anim idest laborum </div>
                </div>
                <div class="image-inner">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                            <figure class="image-box"><img src="images/resource/about-3.jpg" alt=""></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 image-column">
            ...
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 inner-column">
                    <div class="inner-content">
                        <div class="sec-title style-two">
                            <h5>Classess</h5>
                            <h1>Education for Your Children</h1>
                        </div>
    ...
    <!-- our-teachers -->
    <section class="our-teachers style-three sec-pad centred">
        <div class="container">
            <div class="sec-title">
                <h5>Teachers</h5>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-12 col-md-12 news-block">
                    <div class="news-block-two wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.html"><img src="images/resource/news-4.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <ul class="info-box">
                                    <li>20 July, 2019</li>
                                    <li>5 Comments</li>
                                ...
                                <div class="link-btn"><a href="blog-details.html" class="theme-btn">Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-box">
                        <form action="#" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                    <div class="message-btn"><button type="submit" class="theme-btn">Send Message</button></div>
                                </div>
                            </div>
                        </form>
                    </div>
